...
PAPER_ACCOUNTS = [
    ...
    {"name": "10万_基准", "equity0": 100_000, "fill_mode": "next", "entry_score": 4.0,
     ...
     "target_basis": "margin", "max_daily_orders": 60, "max_active_per_sym": 6},
    ...
    {"name": "10万_保守", "equity0": 100_000, "fill_mode": "next", "entry_score": 5.0,
     ...
     "target_basis": "margin", "max_daily_orders": 60, "max_active_per_sym": 6},
    {"name": "10万_赌徒", "equity0": 100_000, "fill_mode": "close", "entry_score": 2.5,
     "per_symbol": 0.35, "max_symbol_weight": 1.0, "max_sector_weight": 1.0,
     "max_concurrent": 999, "risk_liquidate": 1.00, "risk_safe": 0.90,
    ...
    {"name": "1万_保守", "equity0": 10_000, "fill_mode": "next", "entry_score": 5.5,
     ...
     "opt_premium_ratio": 0.35, "stop_loss_ratio": 0.60, "priority": "futures_first",
     "target_basis": "margin", "max_daily_orders": 60, "max_active_per_sym": 6},
    {"name": "1万_赌徒", "equity0": 10_000, "fill_mode": "close", "entry_score": 3.0,
     "per_symbol": 0.40, "max_symbol_weight": 0.50, "max_sector_weight": 0.60,
     "max_concurrent": 999, "risk_liquidate": 0.90, "risk_safe": 0.80,
     "opt_premium_ratio": 0.75, "stop_loss_ratio": 0.70, "priority": "option_first",
     "options_max": None, "target_basis": "margin"},
    ...
    {"name": "5000_基准", "equity0": 5_000, "fill_mode": "next", "entry_score": 4.5,
     ...
     "futures_max": 1, "options_max": None, "target_basis": "margin", "max_daily_orders": 60, "max_active_per_sym": 6},
    {"name": "5000_保守", "equity0": 5_000, "fill_mode": "next", "entry_score": 5.5,
     ...
     "futures_max": 1, "options_max": None, "target_basis": "margin", "max_daily_orders": 60, "max_active_per_sym": 6},
    {"name": "5000_赌徒", "equity0": 5_000, "fill_mode": "close", "entry_score": 3.0,
     "per_symbol": 0.45, "max_symbol_weight": 0.60, "max_sector_weight": 0.70,
     "max_concurrent": 999, "risk_liquidate": 0.80, "risk_safe": 0.70,
     "opt_premium_ratio": 0.75, "stop_loss_ratio": 0.70, "priority": "option_first",
     "options_max": None, "target_basis": "margin"},
    ...
    {"name": "3000_保守", "equity0": 3_000, "fill_mode": "next", "entry_score": 6.0,
     ...
     "futures_max": 0, "options_max": None, "target_basis": "margin", "max_daily_orders": 60, "max_active_per_sym": 6},
    {"name": "3000_赌徒", "equity0": 3_000, "fill_mode": "close", "entry_score": 3.5,
     "per_symbol": 0.59, "max_symbol_weight": 0.60, "max_sector_weight": 0.60,
     "max_concurrent": 999, "risk_liquidate": 0.70, "risk_safe": 0.60,
     "opt_premium_ratio": 0.75, "stop_loss_ratio": 0.70, "priority": "option_first",
     "options_max": None, "target_basis": "margin"},
