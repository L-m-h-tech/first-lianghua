    ...
    "research_cards": {
        ...
        "cards": {
            ...
            "composite_lowvol_family": {
                "cs_mean_ic": "全样本 H20 -0.094（t-3.0，非重叠48期）；低波 H20 -0.140",
                "verdict": "随族观察（placebo 边缘通过）",
                "note": "hv20+range_pct5+range_pct20 逐日截面秩等权平均（regime_cond_lab --compose，第78轮）；"
                        "复合强于任何单成员且跨H/跨子期稳定；第79轮 4种子placebo：伪低波IC min-0.118/"
                        "median-0.097/max-0.057，真实低波-0.140 略出分布上界——增益边缘成立（反向低波≈+13.6%/年，"
                        "样本仅41期、因子有全样本选择偏差）；不进综合分，等更长样本"},
        },
    },
}
