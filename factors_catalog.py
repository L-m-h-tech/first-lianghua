...
CATALOG = (
    # ---------- 进入综合分的 9 个 part（live） ----------
    {
        ...
        "status": "live",
        "introduced": 6,
        "live_at": "factors.NewsFactor+sina_news",
        "archive": "factor_eval/attribution",
    ...
    },
    {
        ...
        "status": "live",
        "introduced": 6,
        "live_at": "oil_data+analyzer(按 oil_w 传导)",
        "archive": "factor_eval/attribution",
    ...
    },
    {
        ...
        "status": "live",
        "introduced": 6,
        "live_at": "webdata 交易可查 aireport(≥3家)",
        "archive": "factor_eval/attribution",
    ...
    },
    {
        ...
        "status": "live",
        "introduced": 6,
        "live_at": "futures_data.compute_indicators→analyzer",
        "archive": "factor_eval/attribution",
    ...
    },
    {
        ...
        "status": "live",
        "introduced": 8,
        "live_at": "futures_data.technical_profile→analyzer",
        "archive": "factor_eval/attribution",
    ...
    },
    {
        ...
        "status": "live",
        "introduced": 9,
        "live_at": "futures_data(30m聚合60m)→analyzer",
        "archive": "factor_eval",
    ...
    },
    {
        ...
        "status": "live",
        "introduced": 13,
        "live_at": "fundamental_factors(库存.40/龙虎.30/carry.20/基差.10)",
        "archive": "factor_eval",
    ...
    # ---------- 基本面四个子项（合成为上面的"基本面"part） ----------
    {
        ...
        "status": "live",
        "introduced": 13,
        "live_at": "fundamental_factors.inventory_factor",
        "archive": "fundamentals表",
    ...
    },
    {
        ...
        "status": "live",
        "introduced": 13,
        "live_at": "fundamental_factors.rank_factor",
        "archive": "fundamentals表",
    ...
    },
    {
        ...
        "status": "live",
        "introduced": 13,
        "live_at": "fundamental_factors.carry_factor",
        "archive": "fundamentals表/carry_eval",
    ...
    },
    {
        ...
        "status": "live",
        "introduced": 13,
        "live_at": "fundamental_factors.basis_factor",
        "archive": "fundamentals表",
    ...
    # ---------- 技术指标原始量（compute_indicators 输出，是上面技术类 part 的原料，本身不直接进分） ----------
    {
        ...
        "status": "live",
        "introduced": 6,
        "live_at": "futures_data.technical_profile",
        "archive": "research_panel",
    ...
    },
    {
        ...
        "status": "live",
        "introduced": 6,
        "live_at": "futures_data.compute_indicators",
        "archive": "research_panel",
    ...
    # ---------- 研究/影子因子（不进综合分） ----------
    {
        ...
        "status": "shadow",
        "introduced": 30,
        "live_at": "futures_data.tsmom_series(影子键)",
        "archive": "tsmom_eval(已归档)",
    ...
    },
    {
        ...
        "status": "archived",
        "introduced": 31,
        "live_at": "无(仅xsmom_eval)",
        "archive": "xsmom_eval(第32轮8候选无一达标归档)",
    ...
    },
    {
        ...
        "status": "tracking",
        "introduced": 34,
        "live_at": "无(仅carry_eval/term_history)",
        "archive": "carry_eval(长9.9年t2.55成立/近4.1年t1.39边缘)",
    ...
    # ===== G25（第38轮）表达式引擎承载的新研究因子：同一条表达式实时/离线同引擎求值，默认 research 不进综合分 =====
    {
        ...
        "status": "research",
        "introduced": 38,
        "live_at": "factor_expr(研究,不进综合分)",
        "archive": "expr_research",
    ...
    },
    {
        ...
        "status": "research",
        "introduced": 81,
        "live_at": "factor_expr(镜像,analyzer默认不换)",
        "archive": "research_panel",
...
HEALTH_SNAPSHOT = {
    ...
    "cards": {
        "新闻消息面": {
            ...
            "ci": [-0.135, +0.302],
            "verdict": "失效预警",
            "note": "次日点估正但滚动窗连续翻转、CI跨零，不稳",
        },
        "原油联动": {
            "ic": +0.276,
            "ci": [+0.045, +0.407],
            "verdict": "健康",
            "note": "次日CI不跨零、同号率0.98，9.3起样本转正",
        },
        "机构动向": {
            "ic": -0.230,
            "ci": [-0.341, -0.118],
    ...
    "research_cards": {
        ...
        "cards": {
            ...
            "expr_tsmom252": {
                ...
                "第82轮 blend OOS：长窗（2018起）正交合成含 tsmom252 后 IC 0.057→0.074（ICIR 0.27→0.36），"
                "对齐净年化 4.60%→8.45%/夏普0.56→1.04；**但 tsmom252 单因子 OOS IC +0.0801/ICIR0.396 "
                "为全因子（含blend）最强**——升级路径=单因子影子/分层多空，而非经正交残差化。"
                "与 xsmom 长窗翻转（第82轮）互证：截面动量在 8.5 年口径下稳健",
            },
            "expr_hv20": {
            ...
            "composite_lowvol_family": {
                ...
                "第82轮 PIT 可识别性检验：翻转前一年（2020/2023）IC均接近0，历史IC序列无法事前识别"
                "符号切换；年度样本仅8个、描述性——**时段性异象正式关闭（不可交易）**，"
                "'前一年市场趋势方向'切换器假设登记为未来方向（需更长样本+正式检验）",
            },
        },
    },
}
...
def catalog_text():
    ...
    L = [
        "特征注册表 factors_catalog（%d 条；live=进综合分 / shadow=影子 / research=研究 / tracking=待样本 / archived=证伪归档）"
        % len(CATALOG)
    ]
    layer_name = {"综合分part": ""}
    for r in CATALOG:
        ...
        L.append(
            "  %-16s %-8s 方向%+d 界%-12s %-8s 第%02d轮 @%s"
            % (r["key"], r["layer"], r["direction"], b, r["status"], r["introduced"], r["live_at"])
        )
    return "\n".join(L) + "\n"
...
def selftest():
    ...
    print(
        "factors_catalog selftest ALL PASS（%d条登记/9个综合分part齐全/字段·方向·状态合法/动态键归一/现状语义/G29体检卡回写）"
        % len(CATALOG)
    )
    return 0
