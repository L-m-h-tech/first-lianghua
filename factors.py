...
SPECIAL_RULES = [
    (r"EIA[^。]{0,30}(减少|下降|降)", 1.6, {EN}),
    (r"EIA[^。]{0,30}(增加|上升)", -1.4, {EN}),
    (r"API[^。]{0,30}(减少|下降)", 1.2, {EN}),
    (r"API[^。]{0,30}(增加|上升)", -1.0, {EN}),
    ...
    (r"USDA[^。]{0,30}(下调|调低)", 1.2, {AG}),
    (r"USDA[^。]{0,30}(上调|调高)", -1.0, {AG}),
    (r"欧佩克[^。]{0,15}减产", 1.8, {EN}),
    (r"欧佩克[^。]{0,15}增产", -1.6, {EN}),
    (r"OPEC\+?[^。]{0,15}减产", 1.8, {EN}),
    (r"OPEC\+?[^。]{0,15}增产", -1.6, {EN}),
    (r"美联储[^。]{0,20}降息", 2.0, ALL),
    (r"美联储[^。]{0,20}加息", -1.8, ALL),
